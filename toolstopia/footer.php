	...
	<div class="ts-container">
		<div class="ts-footer__grid">
			<div class="ts-footer__brand">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="ts-logo"><img src="<?php echo esc_url( TOOLSTOPIA_URI . '/assets/images/logo-white.png' ); ?>" alt="Tooltopia Store" width="190" height="41"></a>
				<p><?php esc_html_e( 'Tooltopia Store is a Kenya-based online retailer supplying tools, equipment and related products for homes, businesses, contractors and workshops. We provide product information, customer support and delivery services across Kenya.', 'toolstopia' ); ?></p>
		...
		<div class="ts-footer__bottom">
			<div>&copy; <?php echo esc_html( date_i18n( 'Y' ) ); ?> Tooltopia Store. <?php esc_html_e( 'All rights reserved.', 'toolstopia' ); ?></div>
...
<a class="ts-wa-float" href="<?php echo toolstopia_wa_url( 'Hello Tooltopia Store! I would like to place an order / ask about a product.' ); ?>" target="_blank" rel="noopener" aria-label="<?php esc_attr_e( 'Order on WhatsApp', 'toolstopia' ); ?>">
...
<nav class="ts-bottomnav" aria-label="<?php esc_attr_e( 'Mobile', 'toolstopia' ); ?>">
	...
	<a href="<?php echo toolstopia_wa_url( 'Hello Tooltopia Store! I would like to order.' ); ?>"><svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a10 10 0 0 0-8.6 15l-1.3 4.7 4.8-1.3A10 10 0 1 0 12 2Z"/></svg><?php esc_html_e( 'WhatsApp', 'toolstopia' ); ?></a>
