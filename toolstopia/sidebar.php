...
if ( is_active_sidebar( 'shop-sidebar' ) ) {
	...
	echo '<a class="ts-btn ts-btn--wa ts-btn--sm" target="_blank" rel="noopener" href="' . toolstopia_wa_url( 'Hi Toolstopia, I need help choosing a tool.' ) . '">' . esc_html__( 'Chat now', 'toolstopia' ) . '</a>';
	echo '</div>';
}
